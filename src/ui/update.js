// Update-check helpers, copied unchanged from core-hunter's app/src/update.js.
// Pure logic only — the version.json fetch and the Status screen's reload
// button live in src/app.js. The running build's version is baked in as
// __APP_VERSION__; the deployed version is read from /version.json (emitted
// at build by vite.config.js's rx-version-json plugin, served no-store) and
// compared here.
