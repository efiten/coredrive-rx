...
test('buildLogHeader reports the ask counters', () => {
  const h = buildLogHeader({
    ...
    asks: {
      ...
      outstanding: 5, flooded: 1, unmatched: 2, dropped: 12, capped: 96, bonus: 2,
  ...
  assert.match(h, /asks cap {3}96 receptions ignored \(this encounter had spent its asks\), 2 extra asks earned/);
